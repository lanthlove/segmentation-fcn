...
其中本次作业使用VOC2012目录下的内容。作业数据集划分位于**VOC2012/g3docets/Segmentation**中，分为train.txt 1464张图片和val.txt1449张图片。
...
![原图](g3doc/val_1000_img.jpg)

标签

![标签](g3doc/val_1000_annotation.jpg)

预测

![预测](g3doc/val_1000_prediction.jpg)

CRF之后的预测

![预测](g3doc/val_1000_prediction_crfed.jpg)
